...
def mcmc_posterior_estimation(params, args):
    """ TODO: docstring """

    # Run emcee
    emcee_result = lmfit.minimize(residual, method='emcee', nan_policy='omit',
                                  burn=300, steps=2000, thin=10, nwalkers=16,
                                  params=params, is_weighted=True, progress=True, args=args)
...
def main():
    ...
    # Run emcee
    mcmc_posterior_estimation(params=nlls_result.params, args=(landmarks, measurements, measurement_covs))
